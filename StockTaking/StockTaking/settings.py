...
SECRET_KEY = 'django-insecure-h45&@+dil7)4s4qb1)8e&l7za2nnhwun^1oli4pu9hox!4*@*d'
...
# CONFIG FILE
parse_file = os.path.join(BASE_DIR, 'config.ini')
...
if config.has_section('database'):
    ...
    raise Exception("Config file has no database section")
